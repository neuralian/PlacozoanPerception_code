# PlacozoanStalker_Datareps
# version for collecting performance data on repeated trials
...
nReps = 64
nFrames = 720      # number of animation frames
...
for rep = 1:nReps
    for n_likelihood_particles = [2048] # [512 1024  2048 4096 8192 ]
        for n_posterior_particles = [2048] # Int.(n_likelihood_particles .÷ [.5 1 2 4])
            for posteriorDeaths = [1] # [.001 .01 .1]
            ...
            initialize_particles(prey) # draw initial sample from prior
                ...
                #record(scene, videoName , framerate=30, 1:nFrames) do i     # generate video file
